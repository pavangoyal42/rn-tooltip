...
*/
const getTooltipCoordinate = (x, y, width, height, ScreenWidth, ScreenHeight, receivedTooltipWidth, withPointer) => {
    const screenDims = react_native_1.Dimensions.get('screen');
    const tooltipWidth = convertDimensionToNumber(receivedTooltipWidth, screenDims.width);
...
const constraintX = (newX, qIndex, _x, ScreenWidth, tooltipWidth) => {
    switch (qIndex) {
